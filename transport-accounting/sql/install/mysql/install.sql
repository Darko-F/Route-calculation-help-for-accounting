CREATE TABLE IF NOT EXISTS `#__transport_accounting_customers` (
  ...
  `customer_city` varchar(250) NOT NULL DEFAULT '',
  `customer_country_code` varchar(2) NOT NULL DEFAULT 'SI',
...
CREATE TABLE IF NOT EXISTS `#__transport_accounting_invoices` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__transport_accounting_invoice_draft_lines` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `customer_id` int unsigned NOT NULL,
  `customer_code` varchar(64) NOT NULL,
  `customer_name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__transport_accounting_invoice_payments` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
