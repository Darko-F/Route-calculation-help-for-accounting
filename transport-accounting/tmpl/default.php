...
$calculatorUrl = Uri::root(true) . '/modules/mod_transport_accounting/media/calculator.html?v=' . rawurlencode($calculatorVersion);
$ajaxUrl = Uri::root() . 'index.php?option=com_ajax&module=transport_accounting&format=json';
$administratorDocumentsUrl = Uri::root() . 'administrator/index.php?option=com_transport_accounting&view=documents';
$tokenName = Session::getFormToken();
$tokenValue = '1';
$globalSettings = ComponentHelper::getParams('com_transport_accounting');
...
$resolvePdfImageUrl = static function ($value): string {
    ...
    return $siteRoot . '/modules/mod_transport_accounting/media/' . ltrim($value, '/');
};
$calculatorTextKeys = [
    'Taxi Transfer VAT Route Calculator' => 'CALCULATOR_TITLE',
    'Transport Accounting' => 'CALCULATOR_NAV_TITLE',
    ...
    'New customer' => 'CALCULATOR_NEW_CUSTOMER',
    ...
    'Update Invoice' => 'CALCULATOR_UPDATE_INVOICE',
    ...
    'Final XML' => 'CALCULATOR_FINAL_XML',
    'Invoice XML' => 'CALCULATOR_INVOICE_XML',
    'Avans XML' => 'CALCULATOR_AVANS_XML',
    'Avans XML exported. Import each advance only once in Minimax.' => 'CALCULATOR_AVANS_XML_EXPORTED',
    ...
    'Invoice no (e.g. TA-26-0001)' => 'CALCULATOR_PLACEHOLDER_INVOICE',
    ...
    'Load a saved invoice before updating it.' => 'CALCULATOR_LOAD_BEFORE_UPDATE_INVOICE',
    'Calculate the corrected route before updating the invoice.' => 'CALCULATOR_CALCULATE_BEFORE_UPDATE_INVOICE',
    'Update saved invoice {documentNumber} with the current values?' => 'CALCULATOR_UPDATE_INVOICE_CONFIRM',
    'Updating invoice...' => 'CALCULATOR_UPDATING_INVOICE',
    'Invoice update failed.' => 'CALCULATOR_UPDATE_INVOICE_FAILED',
    'Invoice updated.' => 'CALCULATOR_INVOICE_UPDATED',
    ...
    'Customer code is required for Minimax XML.' => 'CALCULATOR_CUSTOMER_CODE_REQUIRED_XML',
    'Customer code contains characters unsupported by Minimax.' => 'CALCULATOR_CUSTOMER_CODE_CHARACTERS_XML',
    'Could not load the current customer code. XML export was stopped.' => 'CALCULATOR_CUSTOMER_CODE_REFRESH_FAILED_XML',
    ...
    'Slovenia boundary data could not be loaded. Reload the page and try again.' => 'CALCULATOR_SLOVENIA_BOUNDARY_UNAVAILABLE',
    'Slovenia boundary:' => 'CALCULATOR_SLOVENIA_BOUNDARY_CREDIT',
    'Invalid money amount.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_AMOUNT',
    '{label}: required, maximum {max} characters.' => 'CALCULATOR_MINIMAX_EXPORT_REQUIRED',
    'Invalid document date.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_DATE',
    'Invalid customer code.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_CUSTOMER',
    'Invalid customer country.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_COUNTRY',
    'Minimax journal is not balanced.' => 'CALCULATOR_MINIMAX_EXPORT_UNBALANCED',
    'Missing or invalid saved advance settings.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_SNAPSHOT',
    'Advance must be positive.' => 'CALCULATOR_MINIMAX_EXPORT_POSITIVE_ADVANCE',
    'Invalid advance ID.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_ADVANCE_ID',
    'Advance, VAT and VAT clearing accounts must differ.' => 'CALCULATOR_MINIMAX_EXPORT_DISTINCT_ACCOUNTS',
    'Advance not found.' => 'CALCULATOR_MINIMAX_EXPORT_ADVANCE_NOT_FOUND',
    'Export the final invoice after the service is performed.' => 'CALCULATOR_MINIMAX_EXPORT_AFTER_SERVICE',
    'Invalid advance total or service date.' => 'CALCULATOR_MINIMAX_EXPORT_INVALID_ADVANCE_TOTAL',
    'Unsupported Minimax VAT rate.' => 'CALCULATOR_MINIMAX_EXPORT_UNSUPPORTED_RATE',
    'Mixed base-country VAT rates require separate invoice entries.' => 'CALCULATOR_MINIMAX_EXPORT_MIXED_RATES',
    'Unsupported additional-cost VAT rate.' => 'CALCULATOR_MINIMAX_EXPORT_UNSUPPORTED_COST_RATE',
    'Saved invoice lines do not match the invoice total.' => 'CALCULATOR_MINIMAX_EXPORT_TOTAL_MISMATCH',
    'Missing invoice lines.' => 'CALCULATOR_MINIMAX_EXPORT_MISSING_LINES',
    'Minimax export data could not be loaded.' => 'CALCULATOR_MINIMAX_EXPORT_LOAD_FAILED',
    'Saved invoice not found. Reload the invoice before exporting.' => 'CALCULATOR_MINIMAX_EXPORT_RELOAD_INVOICE',
    'Invoices with recorded advances cannot be edited.' => 'CALCULATOR_MINIMAX_EXPORT_ADVANCE_LOCK',
    'Customer code' => 'CALCULATOR_MINIMAX_EXPORT_CUSTOMER_CODE',
    'Customer address' => 'CALCULATOR_MINIMAX_EXPORT_CUSTOMER_ADDRESS',
    'Customer postcode' => 'CALCULATOR_MINIMAX_EXPORT_CUSTOMER_POSTCODE',
    'Customer city' => 'CALCULATOR_MINIMAX_EXPORT_CUSTOMER_CITY',
    'VAT ID' => 'CALCULATOR_MINIMAX_EXPORT_VAT_ID',
    'Konto' => 'CALCULATOR_MINIMAX_EXPORT_ACCOUNT',
    'Payment reference' => 'CALCULATOR_MINIMAX_EXPORT_PAYMENT_REFERENCE',
    'Advance reference' => 'CALCULATOR_MINIMAX_EXPORT_ADVANCE_REFERENCE',
    'Invoice number' => 'CALCULATOR_MINIMAX_EXPORT_INVOICE_NUMBER',
    'Advance konto' => 'CALCULATOR_MINIMAX_EXPORT_ADVANCE_KONTO',
    'Advance VAT konto' => 'CALCULATOR_MINIMAX_EXPORT_ADVANCE_VAT_KONTO',
    'Advance VAT clearing konto' => 'CALCULATOR_MINIMAX_EXPORT_ADVANCE_CLEARING_KONTO',
    'Final invoice exported with advances and advance VAT deducted. Reconcile the balance in Minimax.' => 'CALCULATOR_XML_EXPORTED_ADVANCES',
...
foreach ($calculatorTextKeys as $sourceText => $keySuffix) {
    $constant = 'MOD_TRANSPORT_ACCOUNTING_' . $keySuffix;
...
$frameId = 'transport_accounting_frame_' . (int) $module->id;
?>
<iframe
  id="<?php echo htmlspecialchars($frameId, ENT_QUOTES, 'UTF-8'); ?>"
  class="transport_accounting-frame"
  title="<?php echo htmlspecialchars(Text::_('MOD_TRANSPORT_ACCOUNTING'), ENT_QUOTES, 'UTF-8'); ?>"
