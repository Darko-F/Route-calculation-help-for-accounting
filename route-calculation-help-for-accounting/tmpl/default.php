...
$calculatorTextKeys = [
    ...
    'Foreign country VAT rate (%)' => 'CALCULATOR_OUTSIDE_VAT_RATE',
    ...
    'Edit country km, VAT rate, account and PDF note. Add rows for countries such as Croatia or Serbia when a route crosses more than one country.' => 'CALCULATOR_COUNTRY_VAT_SPLIT_HELP',
    ...
    'Manual {country} km override' => 'CALCULATOR_MANUAL_BASE_COUNTRY_KM',
    ...
    'Country VAT split recalculated.' => 'CALCULATOR_COUNTRY_SPLIT_RECALCULATED',
    'Enter at least one country row with km.' => 'CALCULATOR_ENTER_COUNTRY_ROW_KM',
    'Country km total must match route total. Country rows: {countryKm}, route: {totalKm}.' => 'CALCULATOR_COUNTRY_KM_MISMATCH',
