...
$calculatorTextKeys = [
    ...
    'Delete invoice {invoiceNumber}? This cannot be undone.' => 'CALCULATOR_DELETE_INVOICE_CONFIRM',
    ...
    'No saved invoice history for this customer. Use "Save Invoice" after calculating a route to store reusable route details.' => 'CALCULATOR_NO_SAVED_INVOICE_HISTORY',
